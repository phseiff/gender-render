    ...
    \begin{flushleft}
        \begin{center}
            \begin{longtable}{|p{8em} | p{28em} |}
                 ...
                 \hline
                 \hline
                 Subject, Object, (In)dependant possessive, Reflexive, Surname, Personal name, "\texttt{<}" + \emph{foo} + "\texttt{>}" & tag is replaced with the value of the corresponding attribute. \\
                 \hline
